...
/******/ 			var chunk = require("./" + ({"1":"pages_index"}[chunkId]||chunkId) + ".js");
  ...
  "messages": {
    "en": {
      ...
      "personalInfo": {
        "name": "Abdul",
        "lastName": "Karim",
        "subHeadingText": ["Software Engineer", "Full Stack Developer", "Code enthusiast!"],
        "city": "Chittagong, Bangladesh",
        "phoneNumber": "+8801781463456",
        "email": "abdulkarim34.fk@gmail.com",
        "linkedin": "https://www.linkedin.com/in/abdul-karim-b05200150/",
        "github": "https://github.com/iamabdulkarim",
        "myDescription": "Passionate web developer, making useful application using the latest technologies!"
      },
      "educationDegrees": {
        "title": "Education 📕",
        "degrees": [{
          "collage": "Hazera tuju Degree Collage",
          "name": "Science",
          "itemList": ["Computer Science"],
          "startEndDate": "Jan 2011 - December 2013"
        }, {
          "collage": "Premier University",
          "name": " Bachelor of Computer Science & Engineering ",
          "itemList": ["Computer Science"],
          "startEndDate": "March 2016 - April 2020"
        }, {
          "collage": "Udemy",
          "name": ["JS Essentials with Vuex and Vue Router"],
          "itemList": ["Web development"],
          "startEndDate": "March 2017 - current 2021"
        }]
      },
      "workExperiences": {
        ...
        "works": [{
          ...
          "companie": "Asil - Smart Solutions",
          "responsabilities": ["Responsible for designing, developing and maintaining a group of application.", "Backend Developer: Php | Laravel | MySQL ", "Frontend Developer: VueJs | Javascript | JQuery."],
          "startEndDate": "july 2020 - Present"
        }]
      },
      "skills": {
        "title": "Skills 🎯",
        "iconsTitle": "Programming Languages & Tools",
        "devIcons": ["devicon-cplusplus-plain colored", "devicon-javascript-plain colored", "devicon-html5-plain-wordmark colored", "devicon-css3-plain-wordmark colored", "devicon-git-plain-wordmark colored", "devicon-nodejs-plain-wordmark colored", "devicon-bootstrap-plain-wordmark colored", "devicon-github-original-wordmark colored", "devicon-bitbucket-original-wordmark", "devicon-laravel-plain-wordmark colored", "devicon-jquery-plain-wordmark colored", "devicon-mysql-plain-wordmark colored", "devicon-visualstudio-plain colored", "devicon-vuejs-plain-wordmark colored"],
        "workflow": "Workflow",
      ...
      "projects": {
        ...
        "projectsInfo": [{
          "name": "Event",
          "description": "Event is build for only show event name, place & time. ",
          "image": "/images/vue-3-events.onrender.com.png",
          "siteUrl": "https://vue-3-events.onrender.com/"
        }, {
          "name": "Food Website",
          "description": "Food website with HTML,CSS & js",
          "image": "/images/food.jpg",
          "siteUrl": "https://food-website.onrender.com/"
        }, {
          "name": "Video Project with Vue ",
          "description": "Udemy course:Vue JS Essentials with Vuex and Vue Router",
          "image": "/images/video-project.png",
          "siteUrl": "#"
        }, {
          "name": "Resume Vue With Nuxt",
          "description": "I made this simple and customizable Portfolio with Vue, nuxt & multilanguage support",
          "image": "/images/resumenuxt.png",
          "siteUrl": "https://github.com/iamabdulkarim/nuxt-resume"
        }]
      }
    },
    "es": {
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "body{font-family:Open Sans,serif;padding-top:54px}body,h1,h2,h3,h4,h5,h6{color:#343a40;color:var(--color-text-primary)}h1,h2,h3,h4,h5,h6{font-family:Saira Extra Condensed,serif;font-weight:700;text-transform:uppercase}h1{font-size:6rem;line-height:5.5rem}h2{font-size:3.5rem}.subheading{text-transform:uppercase;font-weight:500;font-family:Saira Extra Condensed,serif;font-size:1.35rem}.list-social-icons a{color:#0a192f;color:var(--color-primary)}.list-social-icons a:hover{color:#276827;color:var(--color-primary-hover)}.list-social-icons a .fa-lg{font-size:1.75rem}.list-icons{font-size:3rem}.list-icons .list-inline-item i:hover{color:#276827;color:var(--color-primary-hover)}#sideNav .navbar-nav .nav-item .nav-link{font-weight:600;text-transform:uppercase}@media (min-width:992px){#sideNav{text-align:center;position:fixed;top:0;left:0;display:flex;flex-direction:column;width:17rem;height:100vh}#sideNav .navbar-brand{display:flex;margin:auto auto 0;padding:.5rem}#sideNav .navbar-brand .img-profile{max-width:10rem;max-height:10rem;border:.5rem solid #60e8cf}#sideNav .navbar-collapse{display:flex;align-items:flex-start;flex-grow:0;width:100%;margin-bottom:auto}#sideNav .navbar-collapse .navbar-nav{flex-direction:column;width:100%}#sideNav .navbar-collapse .navbar-nav .nav-item,#sideNav .navbar-collapse .navbar-nav .nav-item .nav-link{display:block}}section.resume-section{border-bottom:1px solid #868e96;border-bottom:1px solid var(--color);padding-top:5rem!important;padding-bottom:5rem!important}section.resume-section .resume-item .resume-date{min-width:none}@media (min-width:768px){section.resume-section{min-height:100vh}section.resume-section .resume-item .resume-date{min-width:18rem}}@media (min-width:992px){section.resume-section{padding-top:3rem!important;padding-bottom:3rem!important}}.bg-primary{background-color:#0a192f!important;background-color:var(--color-primary)!important}.text-primary{color:#3b833b!important;color:var(--color-secondary)!important}a:active,a:focus,a:hover{color:#276827;color:var(--color-primary-hover)}.vue-typer .custom.char{color:#343a40;color:var(--color-text-primary)}.card-body,.card-title{color:#868e96}:root{--color:#868e96;--color-primary:#0a192f;--color-secondary:#3b833b;--color-primary-hover:#276827;--color-text-primary:#343a40;--color-text-secondary:#e2e2e2;--color-text-third:#343a40;--bg:#f3f5f4;--bg-secondary:#fff;--border-color:#ddd}.dark-mode{--color:#ebf4f1;--color-primary:#0a0f0a;--color-secondary:#63eed2;--color-primary-hover:#020405;--color-text-primary:#63eed2;--color-text-secondary:#e2e2e2;--bg:#081927;--bg-secondary:#0a192f;--border-color:#0d2538}body{font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,Open Sans,Helvetica Neue,sans-seriff;background-color:#f3f5f4;background-color:var(--bg);color:#868e96;color:var(--color);transition:background-color .3s}a{color:#3b833b;color:var(--color-secondary)}", ""]);
// Exports
module.exports = exports;
...
const _199e244f = () => interopDefault(__webpack_require__.e(/* import() | pages_index */ 1).then(__webpack_require__.bind(null, 42))); // TODO: remove in Nuxt 3
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=176576e3&
var defaultvue_type_template_id_176576e3_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"container content\">","</div>",[_c('nuxt')],1)])}
var defaultvue_type_template_id_176576e3_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=176576e3&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  script,
  defaultvue_type_template_id_176576e3_render,
  defaultvue_type_template_id_176576e3_staticRenderFns,
  false,

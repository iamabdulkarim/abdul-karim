...
import nuxt_plugin_plugin_82689314 from 'nuxt_plugin_plugin_82689314' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_pluginrouting_30bbac00 from 'nuxt_plugin_pluginrouting_30bbac00' // Source: .\\nuxt-i18n\\plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_76668122 from 'nuxt_plugin_pluginmain_76668122' // Source: .\\nuxt-i18n\\plugin.main.js (mode: 'all')
import nuxt_plugin_pluginserver_47095fa0 from 'nuxt_plugin_pluginserver_47095fa0' // Source: .\\color-mode\\plugin.server.js (mode: 'server')
import nuxt_plugin_pluginclient_76c1dea8 from 'nuxt_plugin_pluginclient_76c1dea8' // Source: .\\color-mode\\plugin.client.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_82689314 === 'function') {
    await nuxt_plugin_plugin_82689314(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_30bbac00 === 'function') {
    await nuxt_plugin_pluginrouting_30bbac00(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_76668122 === 'function') {
    await nuxt_plugin_pluginmain_76668122(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_47095fa0 === 'function') {
    await nuxt_plugin_pluginserver_47095fa0(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_76c1dea8 === 'function') {
    await nuxt_plugin_pluginclient_76c1dea8(app.context, inject)
  }
